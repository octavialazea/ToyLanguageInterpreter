...
//
//        Value poz = symTable.lookup(var);
//        IntValue intValue = (IntValue) poz;
//
//        synchronized (lockTable){
//            if (!lockTable.contains(intValue.getValue()))
//                throw new MyException("Value not in lock table!");
//            else if (lockTable.get(intValue.getValue()) == -1)
//                lockTable.add(intValue.getValue(), state.getId());
